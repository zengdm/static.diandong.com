...
var domain = "//static.dd-img.com/h5/"; 	
if (typeof static_resource_version == 'undefined'){
	static_resource_version = '201808291614';
}
seajs.config({
	base: domain,
	'map': [  
    	[ /^(.*\.(?:css|js))(.*)$/i, '$1?v='+static_resource_version ]
  	]  
})
, seajs.config({
		alias: {
			store: "js/util/store/1.3.17/store",
			swiper: "js/util/swiper/2.7.5/swiper",
			cookie: "js/util/cookie/cookie",
			tmplate: "js/util/tmplate/jquery.tmpl.min.js",
			api: "components/api/api",
			lbs: "components/lbs/lbs",
			push: "components/ad/push",
			tongji:'components/tongji/hmt'
		}
	}), seajs.config({
		alias: {
			header: "components/header/header",
			user: "components/user/user",
			tip: "components/tip/tip-656c57cc89",
			interval: "components/interval_v2/interval_v2",
			open: "components/open/open",
		}
	})